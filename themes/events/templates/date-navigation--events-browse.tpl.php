 ...
 */
?>
<div class="date-nav-new pager">
  <div class="date-prev">
    <?php if (!empty($prev_url)) : ?>
      <?php print l("<img src=/" . path_to_theme() . "/images/arrow_white_left.png>" . ($block ? '' : date_t('', 'date_nav')), $prev_url, array('html' => TRUE)); ?>
    <?php endif; ?>
  </div>
  <div class="date-next">
    <?php if (!empty($next_url)) : ?>
      <?php print l("<img src=/" . path_to_theme() . "/images/arrow_white_right.png>" . ($block ? '' : date_t('', 'date_nav')) . '', $next_url,array('html' => TRUE)); ?>
    <?php endif; ?>  
  </div>
